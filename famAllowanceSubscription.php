<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "INSERT INTO fam_allowance_subs (famAllSubs_perc, famAllSubs_basis) VALUES (:percentage, :basis)";
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  <div id="iframeContainer"></div>
    ...
    <div class="pagetitle">
      <h1>Family Allowances Subscription</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item">Parameters</li>
          <li class="breadcrumb-item active">Family Allowances Subscription</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->

    <section class="section">
    <form action="famAllowanceSubscription.php" method="post" id='myForm'>
    <div>
...
try {
    $sql = "SELECT MAX(changeDate) AS max_date FROM fam_allowance_subs";   
    $stmt = $pdo->prepare($sql);
    $stmt->execute();
...
?>
    ...
    <div>
        ...
        <div style='margin-top:1%'>
            <label for='perc' style='margin-left:1%;'>Percentage:</label>
            <input id='perc' name='perc' type='number' value='' style='margin-left:1%;'/>
        </div>
    </div>
    <br/>
...
<script>
    function checkDisplay(obj) {
        ...
        xhr.open("GET", "famSubsInfo.php?date=" + encodeURIComponent(formattedDate), true);
        xhr.send();
    }
