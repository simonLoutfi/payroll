...
document.addEventListener('DOMContentLoaded', function() {
  ...
  <div id="iframeContainer"></div>
    ...
    <div class="pagetitle">
      <h1>General Payslip</h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.html">Home</a></li>
          <li class="breadcrumb-item">Print out</li>
          <li class="breadcrumb-item active">General Payslip</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->

    <section class="section">
    <form action="generatePdf.php" method="post" id='myForm'>
    <div>
        <div style='margin-top:1%'>
            <label for='empName' style='margin-left:1%;'>Employee Name:</label>
            
            <input id='empName' list='names' name='empName' type='text' value='' style='margin-left:1%;'/>
            <datalist id='names'>
            <?php
                          require 'connection.php';

                          try {
                              $sql = "SELECT concat_fname_lname
                                      FROM employee e";
