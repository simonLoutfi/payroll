...
<script>
  ...
  <main id="main" class="main">
    ...
    <div id="iframeContainer"></div>
      ...
      <div class="pagetitle">
            <h1>Close/Open Month</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                    <li class="breadcrumb-item">Parameters</li>
                    <li class="breadcrumb-item active">Close/Open month</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        form.addEventListener('keypress', function(event) {
          if (event.key === 'Enter') {
            ...
            <form id='myForm'>
                ...
                <br>
                <button type="button" onclick="closePeriod()" class='btn btn-primary'>Close</button>
                <button type="button" onclick="openPeriod()" class='btn btn-primary'>Open</button>
            </form>

            <script>
    function closePeriod() {
        var periodId = document.getElementById("monthSelect").value;
        
        $.ajax({
            url: 'close_period.php',
            type: 'POST',
        ...
        console.log("Closing period with ID: " + periodId);
        location.reload();
    }
    ...
    function openPeriod() {
        ...
        console.log("Opening period with ID: " + periodId);
        location.reload();
    }
</script>
